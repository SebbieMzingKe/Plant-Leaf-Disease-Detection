...
if(app_mode=="Home"):
    ...
    Our mission is to help in identifying plant Disease efficiently. Upload an image of a plant, and our system will analyze it to detect any signs of Disease. Together, let's protect our crops and ensure a healthier harvest!
    ...
    if(st.button("Predict")):
        ...
        class_name = ['Apple___Apple_scab', 'Apple___Black_rot', 'Apple___Cedar_apple_rust', 'Apple___healthy',
                    ...
                    'Tomato___Target_Spot', 'Tomato___Tomato_Yellow_Leaf_Curl_Virus', 'Tomato___Tomato_mosaic_virus',
                      'Tomato___healthy']
        st.success("It is predicted to be {}".format(class_name[result_index]))